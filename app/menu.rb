class AppDelegate
  def buildMenu
    ...
    addMenu('File') do
      ...
      addItem(NSMenuItem.separatorItem)
      addItemWithTitle('Delete all entries', action: 'delete_all_entries', keyEquivalent: '')
      addItemWithTitle('Flush time in sticky entries', action: 'flush_sticky_entries', keyEquivalent: '')
